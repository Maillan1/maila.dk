  ...
  return (
    <aside className="space-y-8">
      ...
      <div className="bg-cream border border-warm-200 rounded-lg p-6">
        <h3 className="text-xl font-bold text-purple-900 mb-3">About Maila</h3>
        <p className="text-warm-700 text-sm leading-relaxed">
          Welcome to my creative space where I share thoughts, stories, and inspiration.
      ...
      <div className="bg-gradient-to-br from-purple-50 to-coral-50 border border-purple-200 rounded-lg p-6">
        <h3 className="text-xl font-bold text-purple-900 mb-3">Stay Connected</h3>
